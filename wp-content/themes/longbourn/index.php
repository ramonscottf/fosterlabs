...
<div class="page-header">
    <div class="container">
        <h1><?php echo is_home() ? 'Design Inspirations' : 'Blog'; ?></h1>
        <p>Stories, tips, and the art of meaningful correspondence</p>
    </div>
</div>
    ...
    <div class="container">
        ...
        <?php else : ?>
            <div class="featured-text">
                <h2>No Posts Yet</h2>
                <p>Check back soon for design inspirations and letterpress stories.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
